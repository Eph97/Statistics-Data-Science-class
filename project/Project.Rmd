...
```{r nba_image, echo=FALSE, fig.cap="Source: https://sbcamericas.com/", out.width = '90%'}
knitr::include_graphics("https://oddslifenetstorage.blob.core.windows.net/sbcamericas/2018/07/NBAApp-Playoffs18-Roku-1200x628-1068x559.jpg")
```
...
## How close to reality in the NBA?

So we saw that the RMSE for the college game was 3.15. We can also compare this to the average games difference in the NBA.
...
While the distribution above looks fairly normally distributed, there are some large errors in predicted wins and these are displayed below.
